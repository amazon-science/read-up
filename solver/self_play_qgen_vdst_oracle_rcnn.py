...
from src.model.self_play_qgen_vdst_oracle_rcnn import SelfPlayModel
...
from src.data.self_play_qgen_vdst_oracle_rcnn import SelfPlayDataset, collate_fn
...
class SelfPlaySolver(BaseSolver):
    ...
    def fetch_data(self, data):
        game, obj_feats, tgt_cat, tgt_bbox, tgt_img_feat, cats, bboxs, bboxs_mask, label, qs, q_len = data
        return (
            game,
        ...
        for val_step, data in enumerate(specified_set):
            ...
            with torch.no_grad():
                ...
                pred, dialog, q_log, a_log, a_conf_log = self.model.play(
                    obj_feats, tgt_cat, tgt_bbox, tgt_img_feat, cats, bboxs, bboxs_mask,
