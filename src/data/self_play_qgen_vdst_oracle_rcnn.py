    ...
    def _load_dataset(self):
        with jsonlines.open(self.data_path) as reader:
            ...
            for cur, annotation in tqdm(enumerate(reader)):
                ...
                feats, _, _ = self._image_features_reader_gt[game.image_id]
...
def collate_fn(batch, wrd_pad_id):
    ...
    # batch
    game, qgen_img_feats, qgen_bboxs, tgt_cat, tgt_bbox, tgt_img_feat, cats, bboxs, label, qs = zip(*batch)
    ...
    return game, obj_feats, tgt_cat, tgt_bbox, tgt_img_feat, cats, bboxs, bboxs_mask, label, qs, q_len
