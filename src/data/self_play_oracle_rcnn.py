...
def collate_fn(batch, wrd_pad_id):
    ...
    # batch
    game, img_feat, tgt_cat, tgt_bbox, tgt_img_feat, cats, bboxs, label, qs = zip(*batch)
    ...
    return game, img_feat, tgt_cat, tgt_bbox, tgt_img_feat, cats, bboxs, bboxs_mask, label, qs, q_len
